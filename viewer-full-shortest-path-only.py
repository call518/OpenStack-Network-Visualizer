...
## ex) python viewer-full-shortest-path-only.py --src T:tap94d54818-a5 --dst T:tapeee4966d-68

### Local-VM to Remote-VM
## ex) python viewer-full-shortest-path-only.py --src T:tap94d54818-a5 --dst T:tap708a8386-2f

### Local-VM to External
## ex) python viewer-full-shortest-path-only.py --src T:tap94d54818-a5 --dst "I:eth1(pub-compute-001)"
...
if __name__ == '__main__':
	...
	plt.title("OpenStack Network Connectivity - Full - Shortest-Path (Only)")

	print("Creating GEXF.........")
	nx.write_gexf(G, "/var/www/html/OpenStack-Network-Connectivity.gexf")

	print("Creating Image........")
	plt.savefig("/var/www/html/OpenStack-Network-Connectivity-Full-SP-Only.png", format = "png", dpi = 600)
